    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dish_type', models.CharField(choices=[('mains', 'Mains'), ('snacks', 'Snacks'), ('desserts', 'Desserts')], default='mains', max_length=50)),
                ('prep_time', models.CharField(choices=[('10 minutes', '10 Minutes'), ('15 minutes', '15 Minutes'), ('20 minutes', '20 Minutes'), ('25 minutes', '25 Minutes'), ('30 minutes', '30 Minutes'), ('35 minutes', '35 Minutes'), ('40 minutes', '40 Minutes'), ('45 minutes', '45 Minutes'), ('50 minutes', '50 Minutes'), ('55 minutes', '55 Minutes'), ('1 hour', '1 Hour'), ('1+ hour', '1+ Hour')], default='10 minutes', max_length=50)),
